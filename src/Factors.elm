...
augmentingFactors =
    [ -- Casting Time
      { id = ReduceCastTime1Round, name = "Reduce casting time by 1 round", category = Augmenting, kind = Stackable, dcModifier = 2, multiplierValue = 1, statBlockField = FieldCastingTime, shortDesc = "minimum 1 round" }
    , { id = OneActionCastTime, name = "1-action casting time", category = Augmenting, kind = Toggle, dcModifier = 20, multiplierValue = 1, statBlockField = FieldCastingTime, shortDesc = "Reduces to standard action" }
    , { id = QuickenedSpell, name = "Quickened spell", category = Augmenting, kind = Toggle, dcModifier = 28, multiplierValue = 1, statBlockField = FieldCastingTime, shortDesc = "Cast as a free action; max 1/round" }
    , { id = Contingent, name = "Contingent on specific trigger", category = Augmenting, kind = Toggle, dcModifier = 25, multiplierValue = 1, statBlockField = FieldNone, shortDesc = "" }

    -- Components
    , { id = NoVerbal, name = "No verbal component", category = Augmenting, kind = Toggle, dcModifier = 2, multiplierValue = 1, statBlockField = FieldComponents, shortDesc = "" }
    , { id = NoSomatic, name = "No somatic component", category = Augmenting, kind = Toggle, dcModifier = 2, multiplierValue = 1, statBlockField = FieldComponents, shortDesc = "" }

    -- Duration
    , { id = IncreaseDuration, name = "Increase duration 100%", category = Augmenting, kind = Stackable, dcModifier = 2, multiplierValue = 1, statBlockField = FieldDuration, shortDesc = "" }
    ...
    -- Range
    , { id = IncreaseRange, name = "Increase range 100%", category = Augmenting, kind = Stackable, dcModifier = 2, multiplierValue = 1, statBlockField = FieldRange, shortDesc = "" }
    ...
    -- Area
    , { id = ChangeToBolt, name = "Change area to bolt", category = Augmenting, kind = Toggle, dcModifier = 2, multiplierValue = 1, statBlockField = FieldTargetArea, shortDesc = "5 ft. x 300 ft. OR 10 ft. x 150 ft." }
    , { id = ChangeToCylinder, name = "Change area to cylinder", category = Augmenting, kind = Toggle, dcModifier = 2, multiplierValue = 1, statBlockField = FieldTargetArea, shortDesc = "10-ft. radius, 30 ft. high" }
    ...
    , { id = AreaToTouch, name = "Area → touch/ray", category = Augmenting, kind = Toggle, dcModifier = 4, multiplierValue = 1, statBlockField = FieldTargetArea, shortDesc = "Close range (25 ft. + 5 ft./2 levels)" }
    , { id = IncreaseArea, name = "Increase area 100%", category = Augmenting, kind = Stackable, dcModifier = 4, multiplierValue = 1, statBlockField = FieldTargetArea, shortDesc = "" }

    -- Save DC
    , { id = IncreaseSaveDC, name = "Increase save DC by +1", category = Augmenting, kind = Stackable, dcModifier = 2, multiplierValue = 1, statBlockField = FieldSaveDC, shortDesc = "" }
    ...
    -- Other
    , { id = StoneTablet, name = "Recorded onto stone tablet", category = Augmenting, kind = DcMultiplier, dcModifier = 0, multiplierValue = 2, statBlockField = FieldNone, shortDesc = "x2 multiplier on total DC" }
    , { id = IncreaseDamageDie, name = "Increase damage die +1 step", category = Augmenting, kind = Stackable, dcModifier = 10, multiplierValue = 1, statBlockField = FieldNone, shortDesc = "max d20" }
    ]
...
mitigatingFactors =
    [ { id = Backlash, name = "Backlash (1d6 per die to caster)", category = Mitigating, kind = Stackable, dcModifier = -1, multiplierValue = 1, statBlockField = FieldNone, shortDesc = "Caster takes Xd6 on casting or per round (max = HD×2 dice)" }
