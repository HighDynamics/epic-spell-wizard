...
afflict =
    ...
    , range = "300 ft."
    , target = Just "One living creature"
    , area = Nothing
    , effect = Nothing
    , duration = "20 minutes"
...
animate =
    ...
    , castingTime = "1 minute"
    , range = "300 ft."
    , target = Just "Object or 20 cu. ft. of matter"
    , area = Nothing
    , effect = Nothing
    , duration = "20 rounds"
    , savingThrow = Nothing
...
animateDead =
    ...
    , castingTime = "1 minute"
    , range = "Touch"
    , target = Just "One or more corpses touched"
    , area = Nothing
    , effect = Nothing
...
banish =
    ...
    , castingTime = "1 minute"
    , range = "75 ft."
    , target = Just "One or more extraplanar creatures, no two more than 30 ft. apart"
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
    , savingThrow = Just { saveType = WillSave, effect = Negates, harmless = False }
...
conceal =
    ...
    , target = Just "You or a creature or object of up to 2,000 lb."
    , area = Nothing
    , effect = Nothing
...
conjure =
    ...
    , target = Nothing
    , area = Nothing
    , effect = Just "Unattended, nonmagical object of nonliving matter up to 20 cu. ft."
...
delude =
    ...
    , target = Nothing
    , area = Nothing
    , effect = Just "Visual figment up to twenty 30-ft. cubes (S)"
...
destroy =
    ...
    , castingTime = "1 minute"
    , range = "12,000 ft."
    , target = Just "One creature, or up to a 10-ft. cube of nonliving matter"
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
...
dispel =
    ...
    , castingTime = "1 minute"
    , range = "300 ft."
    , target = Just "One creature, object, or spell"
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
    , savingThrow = Nothing
...
energy =
    ...
    , range = "300 ft."
    , target = Nothing
    , area = Just "20-ft.-radius hemisphere burst"
    , effect = Nothing
    , duration = "Instantaneous"
...
life =
    ...
    , castingTime = "1 minute"
    , range = "Touch"
    , target = Just "Dead creature touched"
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
    , savingThrow = Nothing
...
slay =
    ...
    , castingTime = "1 minute"
    , range = "300 ft."
    , target = Just "One living creature of up to 80 HD"
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
...
summon =
    ...
    , target = Nothing
    , area = Nothing
    , effect = Just "One summoned creature"
...
transport =
    ...
    , castingTime = "1 minute"
    , range = "Touch"
    , target = Just "You and touched willing creatures up to 1,000 lb."
    , area = Nothing
    , effect = Nothing
    , duration = "Instantaneous"
    , savingThrow = Nothing
...
ward =
    ...
    , castingTime = "1 minute"
    , range = "Touch"
    , target = Just "Touched creature or object up to 2,000 lb."
    , area = Just "10-ft.-radius emanation"
    , effect = Nothing
