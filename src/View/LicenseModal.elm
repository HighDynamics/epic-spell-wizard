module View.LicenseModal exposing (viewLicenseModal)
    ...
    div [ class "fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4" ]
        [ div [ class "bg-gray-900 border border-gray-700 rounded-lg max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 space-y-4" ]
            [ div [ class "flex items-center justify-between" ]
                [ h2 [ class "text-lg font-bold text-arcane-400" ] [ text "Open Game License" ]
                , button
